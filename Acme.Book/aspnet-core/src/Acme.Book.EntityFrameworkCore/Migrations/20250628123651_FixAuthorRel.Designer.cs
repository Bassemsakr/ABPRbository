...
namespace Acme.Book.Migrations
{
    ...
    [Migration("20250628123651_FixAuthorRel")]
    partial class FixAuthorRel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.Book.Author.AuthorEntity", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Acme.Book.Entitis.BooktEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.Book.Entitis.BooktEntity", b =>
                {
                    b.HasOne("Acme.Book.Author.AuthorEntity", null)
                        .WithMany()
